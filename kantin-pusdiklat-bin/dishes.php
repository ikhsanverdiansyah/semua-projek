  ...
  <a class="navbar-brand" href="#">
    <img src="images/logokantin2.png" width="30" height="30" class="d-inline-block align-top" alt=""> Kantin Pusdiklat BIN
        ...
        <div class="page-wrapper">
            ...
            <div class="widget widget-cart" style= "padding-left: 30px; padding-right: 30px">
                                <div class="widget-heading">
                                    <h3 class="widget-title text-dark">Keranjang
                              </h3>
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" >Rp<?php echo $product['price']; ?></span>
										  ...
										  <input type="submit" class="btn theme-btn" style="margin-left:40px;" value="Beli" />
										</div>
										</form>
                                    </div>
