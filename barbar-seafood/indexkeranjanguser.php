  ...
  require_once 'header.php';
    ...
    <div class="container mt-5">
      ...
      <div class="row mb-2">
        ...
        <div class="col">
          <form class="form-inline pull-right" action="" method="GET">
            ...
            <button type="submit" class="btn btn-success mb-2"></i>Cari</button>
          </form>
        </div>
      </div>
      ...
      <table class="table">
        ...
        <a href="indexuser.html"><button class="btn btn-danger"> <i class="fa fa-arrow-left"></i>Kembali Ke Menu</button></a>
      </div>
